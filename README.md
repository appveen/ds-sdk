...
Returns a [TransactionMethods object](#TransactionMethods) Wrapper Object with useful methods.
...
Returns a Promise giving a [DataStackDocument object](https://stackedit.io/app#DataStackDocument) if the operation is success, else will throw an [ErrorResponse object](https://stackedit.io/app#ErrorResponse).
